...
def register_routes(app):
    ...
    def create_supplier():
        errors = []
        supplier= Supplier(name = '', contact_email = '', phone = '')
        ...
        if request.method == "POST":
            ...
            if contact_email and "@" not in contact_email:
                errors.append("El mail de contacto no es válido.")
        ...
        return render_template ("suppliers_from.html", errors=errors, supplier=supplier)
    ...
    def delete_supplier(supplier_id):
        ...
        if supplier.products:
            flash("No se puede eliminar un proveedor con productos asociados.")
            return redirect(url_for("list_suppliers"))
